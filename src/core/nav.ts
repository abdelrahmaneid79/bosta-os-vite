...
export interface NavSection { id: string; label: string; icon: string; tabs: NavTab[] }

export const NAV_SECTIONS: NavSection[] = [
  { id: "today", label: "Today", icon: "M3 10.5 12 3l9 7.5M5 9.5V20h14V9.5", tabs: [
    { to: "/dashboard", label: "Today" },
  ] },
  { id: "sales", label: "Sales", icon: "M3 3v18h18M7 14l3-3 3 3 5-6", tabs: [
    { to: "/sales", label: "Sales days" },
    { to: "/sales/import", label: "Import & receipts" },
  ] },
  { id: "inventory", label: "Inventory", icon: "M4 7l8-4 8 4v10l-8 4-8-4zM4 7l8 4 8-4M12 11v10", tabs: [
    { to: "/stock", label: "Stock" },
    { to: "/purchases", label: "Purchases" },
  ] },
  { id: "money", label: "Money", icon: "M3 7h18v11H3zM3 11h18M7 15h3", tabs: [
    { to: "/money", label: "Cash" },
    { to: "/expenses", label: "Spend" },
    { to: "/cheques", label: "Cheques" },
    { to: "/expenses/import", label: "Import expenses" },
  ] },
  { id: "reports", label: "Reports", icon: "M6 2h9l5 5v15H4V2zM9 13h6M9 17h6", tabs: [
    { to: "/reports", label: "Overview" },
    { to: "/reconcile", label: "Profit" },
    { to: "/reports/tables", label: "Tables & export" },
  ] },
  { id: "insights", label: "Insights", icon: "M22 12h-4l-3 8L9 4l-3 8H2", tabs: [
